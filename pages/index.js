    ...
    <div className={styles.container}>
      ...
      <div className={styles['landing-page-container']}>
        <div className={styles['vertical-align-image-left']}>
          <Image
            src="https://replicate.delivery/pbxt/eaIJTMsJefGNWoitWiAPtxFlcRS9vm2Kpp7XmHkRrR16N0QgA/out-0.png"
            alt=""
            width={400}
            height={400}
          />
      ...
      <div className={styles['landing-page-container']}>
        <div className={styles['vertical-align-image-right']}>
          <Image src="/GPT3_Screenshot.png" alt="" width={400} height={400} />
        </div>
        <div className={styles['vertical-align-text']}>
          <h1>
            Generate any captions you want, whenever you want, for your images.
