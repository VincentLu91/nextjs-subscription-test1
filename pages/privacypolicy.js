const privacypolicy = () => {
  return (
    <div>
	  ...
	  <li>
	  <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to aperture ai.</p>
	  </li>
	  <li>
	  ...
	  <li>
	  <p><strong>Website</strong> refers to aperture ai, accessible from <a href="http://apertureai.com." rel="external nofollow noopener" target="_blank">http://apertureai.com.</a></p>
	  </li>
	  <li>
	  ...
	  <ul>
	  <li>By email: info@apertureai.com</li>
	  </ul>
	</div>
  );
};
