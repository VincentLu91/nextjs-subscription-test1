...
CREATE TABLE IF NOT EXISTS "public"."ai-models" (
    "id" bigint NOT NULL,
...
ALTER TABLE "public"."ai-models" OWNER TO "postgres";


ALTER TABLE "public"."ai-models" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."ai-models_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."customers" (
    ...
    "image_tokens" bigint DEFAULT '0'::bigint NOT NULL,
    "training_tokens" bigint,
    "caption_tokens" bigint
);
...
ALTER TABLE ONLY "public"."ai-models"
    ADD CONSTRAINT "ai-models_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."photos"
    ADD CONSTRAINT "photos_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id");
...
GRANT ALL ON TABLE "public"."ai-models" TO "anon";
GRANT ALL ON TABLE "public"."ai-models" TO "authenticated";
GRANT ALL ON TABLE "public"."ai-models" TO "service_role";



GRANT ALL ON SEQUENCE "public"."ai-models_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."ai-models_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."ai-models_id_seq" TO "service_role";
