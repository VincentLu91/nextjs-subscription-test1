...
export default function Pricing({ products }) {
  ...
  return (
    <section className="bg-blue"> // originally bg-black
      <div className="max-w-6xl mx-auto py-8 sm:py-24 px-4 sm:px-6 lg:px-8">
        ...
        <div>
          ...
          <ul>
			<li className="text-xs uppercase text-center">- unique, quality images generated by AI</li>
			<li className="text-xs uppercase text-center">- images are sourced from top notch photographers and influencers</li>
		  </ul>
        </div>
      </div>
    </section>
